        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AtrrId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttrAndPro", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Res_model = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleOrders_CustomerProfiles_CustomerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesLong = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_ProductUom_UomId",
                        column: x => x.UomId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attribute_ProId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attribute_Values", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attribute_Values_Attributes_Attribute_ProId",
                        column: x => x.Attribute_ProId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attribute_Values_Attribute_ProId",
                table: "Attribute_Values",
                column: "Attribute_ProId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleOrders_CustomerProfileId",
                table: "SaleOrders",
